package io.yamsergey.adt.cli.drawable;
 ...
 * adt-cli drawable -i ic_launcher.xml -o ic_launcher.png
 *
 * # Convert with custom size
 * adt-cli drawable -i ic_launcher.xml -o ic_launcher.png -w 1024 -h 1024
 *
 * # Convert with density-based sizing
 * adt-cli drawable -i ic_launcher.xml -o ic_launcher.png --density xxxhdpi
 * </pre>
 */
